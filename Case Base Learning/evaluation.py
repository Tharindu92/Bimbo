...
readFile4 = 'G:/Academic/Data Mining/Bimbo/Training Set/medianDemandWeek8_9_1.csv'

writeFile = 'G:/Academic/Data Mining/Bimbo/Training Set/answer1_9.csv'

readTest = 'G:/Academic/Data Mining/Bimbo/Training Set/answer2_9.csv'


medianFile1 = open(readFile4,'r')
...
for row in testReader:
    ...
    if not row[0] == 'Canal_ID':
        ...
        medianReader4 = csv.reader(medianFile1 ,delimiter=',', quotechar='\n')
